...
#+END_SRC
** COMMENT Generate Database (-d)
This flag will turn on database generation, assuming that it is enabled.

# <2019-06-15 Sat> This is being disabled so I can rework
# the interface to use the SQLite API.
...
# <2019-06-15 Sat> Commenting functionality out for now.
...
,*/
    ...
    fprintf(stderr, "Database functionality has been disabled\n");
}
#endif
#+END_SRC
