...
#+END_SRC
*** TODO Parser Wrap-up
When writing a database, the last segment isn't getting
appended. I'm guessing it has to do with the fact that it
is last, and most of the appending behaviors rely on
switching states.
#+NAME: parser_wrapup
#+BEGIN_SRC c
/* TODO */
...
This line is needed due to a bug with worgmap. Remove it,
and the last segment in the code block won't be linked
properly. Will fix this ASAP.
