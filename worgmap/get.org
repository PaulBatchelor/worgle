...
#+NAME: available_commands
#+BEGIN_SRC c
fprintf(stderr, "block: prints block info given UUID\n");
#+END_SRC
...
#+BEGIN_SRC c
fprintf(stderr,
        "segment: prints segment info given UUID\n");
#+END_SRC

#+NAME: function_declarations
#+BEGIN_SRC c
static int get_segment(int argc, char *argv[]);
#+END_SRC
...
#+NAME: command_parsing
#+BEGIN_SRC c
else if (!strncmp(argv[1], "segment", 5)) {
    argv++;
    argc--;
    get_segment(argc, argv);
}
#+END_SRC
** TODO file
